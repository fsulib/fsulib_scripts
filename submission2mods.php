...
$else_email = "bjbrown@fsu.edu, dsoper@fsu.edu, scstanley@fsu.edu, aretteen@fsu.edu, mll07f@my.fsu.edu";
...
foreach ($submissions as $submission) {
  if ($submission->field_submission_status->und->n0->value == "approved") {
    if ($submission->field_submission_type->und->n0->value != "hthesis") {
